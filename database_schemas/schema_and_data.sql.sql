-- =====================================================
-- Patient-Trial Matching Database - DB-Fiddle Version
-- =====================================================
-- Simplified for DB-Fiddle compatibility
...
-- =====================================================
-- TABLE: MedicalCondition (renamed to avoid SQL reserved word)
-- =====================================================
...
-- =====================================================
-- TABLE: PatientCondition (Junction Table)
-- =====================================================
...
-- =====================================================
-- TABLE: PatientMedication (Junction Table)
-- =====================================================
...
(8, 2, '2016-05-25', NULL),
(9, 2, '2020-08-01', NULL),
(9, 10, '2022-03-15', NULL),
(10, 8, '2016-01-10', NULL),
(10, 6, '2012-09-15', NULL),
(10, 9, '2012-09-15', NULL),
(11, 3, '2023-01-20', NULL),
(13, 1, '2020-10-10', NULL),
(13, 2, '2021-03-25', NULL),
